...
auth_params = {
     'key': "fdecfffdfb7163568d443cc0c9cea8a0",    
    'token':"f422f188ebba6ca2af41ae930d28976104adb5133ddb6c9cf3bfd1922ad281af",}
board_id = "5e9eba4fd83d0b660294d9ad"
...
def read():
    ...
    #API Trello
    print('///////КОНСОЛЬНЫЙ КЛИЕНТ API Trello/////////')
    ...
    for column in column_data:
        ...
        print('*********************************************')
        print("КОЛОНКА:{}".format(column['name']) + "----ЗАДАЧ:{}".format(len(task_data)))
